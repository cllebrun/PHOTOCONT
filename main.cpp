...
int publish(MQTT::Client<MQTTEthernet, Countdown, MQTT_MAX_PACKET_SIZE>* client, MQTTEthernet* ipstack)
{
    ...
    sprintf(buf,
     "{\"d\":{\"temp\":%0.4f,\"DAC_Value\":%hu,\"State\":%#x,\"Power\":%u,\"Old_Power\":%u,\"wJourTimer\":%hu,\"wNuitTimer\":%hu,\"wCurrentTimer\":%hu,\"Rotary_mode\":%x,\"v_iphoto\":%hx,\"v_vphoto\":%hx,\"v_bat\":%hx,\"bNuit\":%x}}",
